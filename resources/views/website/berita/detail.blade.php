...
<div class="row">
    <div class="detail col-md-9">
      <article class="blog-post mb-2">
        ...
        <p class="blog-post-meta">{{ $updated }} oleh <a href="#" style="text-decoration: none">{{ $data->author }}</a></p>
    ...
    <div class="col-md-3 bg-light" >
      <div class="position-sticky" style="top: 4rem;">
        <div class="p-4"  >
          <h5 class="mb-3" style="font-weight: 600">Berita Lainnya</h5>
          <ul class="list-unstyled">
            @foreach ($others as $other)
                <li class="d-flex align-items-center mb-3">
                    ...
                    <div>
                        <a href="/berita/{{ $other->slug }}" style="text-decoration: none;"><h6 class="mb-1"><i>{{ $other->title }}</i></h6></a>
                    </div>
                </li>
            @endforeach
        </ul>
